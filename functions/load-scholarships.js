...
function generateScholarships() {
  ...
  const niches = ['Agriculture', 'Animal Welfare', 'Arts', 'Automation', 'Aviation', 'Biotechnology', 'Blockchain', 'Broadcasting', 'Chemistry', 'Chiropractic', 'Cinematography', 'Communications', 'Computer Science', 'Construction', 'Consumer Affairs', 'Cosmetology', 'Criminal Justice', 'Culinary', 'Cybersecurity', 'Data Science', 'Dental', 'Design', 'Diagnostics', 'Digital Media', 'Drama', 'Economics', 'Education', 'Electrical', 'Electronics', 'Emergency Services', 'Energy', 'Engineering', 'Entertainment', 'Entrepreneurship', 'Environmental', 'Equine', 'Event Planning', 'Fashion', 'Film', 'Finance', 'Fire Science', 'Food Service', 'Forensic Science', 'Game Design', 'Genetics', 'Geography', 'Geology', 'Gerontology', 'Graphic Design', 'Guidance Counseling', 'Health', 'Health Information', 'History', 'Horticulture', 'Hospitality', 'Human Resources', 'Human Services', 'Industrial', 'Information Systems', 'Information Technology', 'Insurance', 'Interior Design', 'International Relations', 'Journalism', 'Kinesiology', 'Laboratory', 'Landscape Architecture', 'Languages', 'Law', 'Law Enforcement', 'Leadership', 'Librarianship', 'Linguistics', 'Logistics', 'Maintenance', 'Marine Biology', 'Marketing', 'Mathematics', 'Mechanical', 'Media', 'Medical', 'Mental Health', 'Military', 'Mining', 'Mortuary Science', 'Museum', 'Music', 'Natural Resources', 'Navigation', 'Nursing', 'Nutrition', 'Occupational Therapy', 'Oceanography', 'Operations Management', 'Optometry', 'Organizational', 'Orthotics', 'Paleontology', 'Paralegal', 'Parks Recreation', 'Pharmacy', 'Philosophy', 'Photography', 'Physical Science', 'Physical Therapy', 'Physics', 'Physician Assistant', 'Physiology', 'Plastics', 'Podiatry', 'Political Science', 'Project Management', 'Prosthetics', 'Psychology', 'Public Administration', 'Public Health', 'Public Policy', 'Public Relations', 'Quality Assurance', 'Radiation', 'Radiology', 'Real Estate', 'Recreation', 'Rehabilitation', 'Religious Studies', 'Respiratory', 'Risk Management', 'Robotics', 'Science', 'Social Work', 'Sociology', 'Software', 'Soil Science', 'Space', 'Special Education', 'Speech', 'Sports', 'Statistics', 'Supply Chain', 'Sustainability', 'Systems Engineering', 'Theater', 'Therapy', 'Transportation', 'Travel', 'Urban Planning', 'Veterinary', 'Video Production', 'Web Development', 'Welding', 'Wildlife', 'Writing', 'Zoology'];
